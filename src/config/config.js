...
const EXTRAS = `,studytechbr,studytech,mulhertech,girltech,bubbletech,discloud,ravenastar,elastech,@${process.env.BLUESKY_USERNAME}`
...
const embed_bannerURL = "https://i.imgur.com/xSARWn5.png"
